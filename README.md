Developed a responsive site that ensures that web applications render well on a variety of devices and screen sizes.  I created as a default mobile-first application. 
